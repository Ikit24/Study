...
def connect_to_mail():
    mail = imaplib.IMAP_SSL("imap.gmail.com")
...
def click_link(link):
    try:
        ...
        print("Errir with", link, str(e))

def extract_links_from_html(html_content):
    soup = BeautifulSoup(html_content, "html.parser")
    links = [link["href"] for link in soup.find_all("a", hred=True) if "unsubscribe" in link["href"].lower()]
    return links
